...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:InsurancePlan">
      ...
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/plan-group-code']) &lt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/plan-group-code': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/plan-group']) &lt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/plan-group': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
