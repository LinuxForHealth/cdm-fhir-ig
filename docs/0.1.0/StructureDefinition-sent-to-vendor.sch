...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'http://alvearie.github.io/alvearie-fhir-ig/StructureDefinition/sent-time']) &lt;= 1">extension with URL = 'http://alvearie.github.io/alvearie-fhir-ig/StructureDefinition/sent-time': maximum cardinality of 'extension' is 1</sch:assert>
