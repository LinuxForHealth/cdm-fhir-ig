...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:extension">
      ...
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://alvearie.io/fhir/StructureDefinition/match-source-reference']) &gt;= 1">extension with URL = 'http://alvearie.io/fhir/StructureDefinition/match-source-reference': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://alvearie.io/fhir/StructureDefinition/match-source-reference']) &lt;= 1">extension with URL = 'http://alvearie.io/fhir/StructureDefinition/match-source-reference': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://alvearie.io/fhir/StructureDefinition/match-method']) &lt;= 1">extension with URL = 'http://alvearie.io/fhir/StructureDefinition/match-method': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://alvearie.io/fhir/StructureDefinition/split-method']) &lt;= 1">extension with URL = 'http://alvearie.io/fhir/StructureDefinition/split-method': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'http://alvearie.io/fhir/StructureDefinition/match-period']) &lt;= 1">extension with URL = 'http://alvearie.io/fhir/StructureDefinition/match-period': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Patient.extension.extension.extension.extension</sch:title>
    <sch:rule context="f:Patient/f:extension/f:extension/f:extension/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Patient.extension.extension.extension.value[x] 1</sch:title>
    <sch:rule context="f:Patient/f:extension/f:extension/f:extension/f:value[x]">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
