...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/family-id']) &lt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/family-id': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/primary-payer']) &lt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/primary-payer': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/secondary-payer']) &lt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/secondary-payer': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:address">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/county-code']) &lt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/county-code': maximum cardinality of 'extension' is 1</sch:assert>
