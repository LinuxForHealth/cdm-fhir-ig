...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CommunicationRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/communication-contact']) &gt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/communication-contact': minimum cardinality of 'extension' is 1</sch:assert>
