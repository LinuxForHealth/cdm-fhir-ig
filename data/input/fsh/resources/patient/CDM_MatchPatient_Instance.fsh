...
/////
* extension[seeAlso][2].extension[8].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-organization"
* extension[seeAlso][2].extension[8].valueString = "HDC"
* extension[seeAlso][2].extension[9].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-type"
* extension[seeAlso][2].extension[9].valueString = "Manual Patient Match"
* extension[seeAlso][2].extension[10].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-name"
* extension[seeAlso][2].extension[10].valueString = "Web Portal"
* extension[seeAlso][2].extension[11].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-version"
* extension[seeAlso][2].extension[11].valueString = "1.0"
* extension[seeAlso][2].extension[12].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-timestamp"
...
* extension[seeAlso][3].extension[8].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/split-method"
* extension[seeAlso][3].extension[8].valueCodeableConcept = MatchMethodCodeSystem#manual
* extension[seeAlso][3].extension[9].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-organization"
* extension[seeAlso][3].extension[9].valueString = "HDC"
* extension[seeAlso][3].extension[10].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-type"
* extension[seeAlso][3].extension[10].valueString = "Manual Patient Split"
* extension[seeAlso][3].extension[11].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-name"
* extension[seeAlso][3].extension[11].valueString = "Web Portal"
* extension[seeAlso][3].extension[12].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-version"
* extension[seeAlso][3].extension[12].valueString = "1.0"
* extension[seeAlso][3].extension[13].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-timestamp"
