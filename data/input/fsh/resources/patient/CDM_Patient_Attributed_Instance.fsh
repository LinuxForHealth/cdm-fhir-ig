...
* generalPractitioner[1].extension[2].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-organization"
* generalPractitioner[1].extension[2].valueString = "HDC"
* generalPractitioner[1].extension[3].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-type"
* generalPractitioner[1].extension[3].valueString = "Practitioner Attribution"
* generalPractitioner[1].extension[4].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-name"
* generalPractitioner[1].extension[4].valueString = "Claims Enrollment PCP Attribution"
* generalPractitioner[1].extension[5].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-version"
* generalPractitioner[1].extension[5].valueString = "1.0"
* generalPractitioner[1].extension[6].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-timestamp"
...
* generalPractitioner[2].extension[2].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-organization"
* generalPractitioner[2].extension[2].valueString = "HDC"
* generalPractitioner[2].extension[3].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-type"
* generalPractitioner[2].extension[3].valueString = "Practitioner Attribution"
* generalPractitioner[2].extension[4].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-name"
* generalPractitioner[2].extension[4].valueString = "Claims Enrollment PCP Attribution"
* generalPractitioner[2].extension[5].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-version"
* generalPractitioner[2].extension[5].valueString = "1.0"
* generalPractitioner[2].extension[6].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-timestamp"
...
* generalPractitioner[3].extension[3].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-organization"
* generalPractitioner[3].extension[3].valueString = "HDC"
* generalPractitioner[3].extension[4].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-type"
* generalPractitioner[3].extension[4].valueString = "Practitioner Attribution"
* generalPractitioner[3].extension[5].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-name"
* generalPractitioner[3].extension[5].valueString = "Advantage PCP Attribution"
* generalPractitioner[3].extension[6].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-version"
* generalPractitioner[3].extension[6].valueString = "1.0"
* generalPractitioner[3].extension[7].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-timestamp"
...
* generalPractitioner[4].extension[4].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-organization"
* generalPractitioner[4].extension[4].valueString = "HDC"
* generalPractitioner[4].extension[5].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-type"
* generalPractitioner[4].extension[5].valueString = "Practitioner Attribution"
* generalPractitioner[4].extension[6].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-name"
* generalPractitioner[4].extension[6].valueString = "Engagement PCP Attribution"
* generalPractitioner[4].extension[7].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-version"
* generalPractitioner[4].extension[7].valueString = "1.0"
* generalPractitioner[4].extension[8].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-timestamp"
...
* generalPractitioner[5].extension[4].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-organization"
* generalPractitioner[5].extension[4].valueString = "HDC"
* generalPractitioner[5].extension[5].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-type"
* generalPractitioner[5].extension[5].valueString = "Practitioner Attribution"
* generalPractitioner[5].extension[6].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-name"
* generalPractitioner[5].extension[6].valueString = "Engagement PCP Attribution"
* generalPractitioner[5].extension[7].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-version"
* generalPractitioner[5].extension[7].valueString = "1.0"
* generalPractitioner[5].extension[8].url = "http://linuxforhealth.org/fhir/cdm/StructureDefinition/process-timestamp"
