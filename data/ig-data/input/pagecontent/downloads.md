* **[Snapshot v{{site.data.fhir.ig.version}} JAR (ig-common-data-model-{{site.data.fhir.ig.version}}-SNAPSHOT.jar)](ig-common-data-model-{{site.data.fhir.ig.version}}-SNAPSHOT.jar)**<br />
