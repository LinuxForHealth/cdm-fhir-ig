...
* extension contains UsualAndCustomaryAmount named usualAndCustomaryAmount 0..1
* extension[usualAndCustomaryAmount] ^short      = "Usual and customary amount on the drug claim"
* extension[usualAndCustomaryAmount] ^definition = "Usual and customary amount on the drug claim"
