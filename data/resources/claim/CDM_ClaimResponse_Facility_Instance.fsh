...
* item.adjudication[9].reason.coding.system = "http://acme-health.com/CodeSystem/local-discount-type"
* item.adjudication[9].reason.coding.code   = #LocalDiscountType
...
* item.adjudication[18].reason.coding[0]   = http://acme-health.com/CodeSystem/local-penalty-type#LocPenaltyType
...
* item.adjudication[21].reason.coding.system  = "http://acme-health.com/CodeSystem/local-excluded-reason_1"
* item.adjudication[21].reason.coding.code    = #LocalExcludedReason1
...
* item.adjudication[22].reason.coding.system  = "http://acme-health.com/CodeSystem/local-excluded-reason_2"
* item.adjudication[22].reason.coding.code    = #LocalExcludedReason2
* item.adjudication[23].category              = AdjudicationCategoryCodeSystem#excluded-reason
* item.adjudication[23].reason.coding.system  = "http://acme-health.com/CodeSystem/local-excluded-reason_3"
* item.adjudication[23].reason.coding.code    = #LocalExcludedReason3
