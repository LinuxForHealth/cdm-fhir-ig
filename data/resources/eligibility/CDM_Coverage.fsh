 ...
 * extension[employeeJobLocation] ^short      = "Customer-specific code for thephysical location where the employee works"
 * extension[employeeJobLocation] ^definition = "Customer-specific code for thephysical location where the employee works"
