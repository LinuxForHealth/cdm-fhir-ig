...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile QualityMeasureReport
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MeasureReport">
      ...
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/measure-report-assigned-practitioner']) &lt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/measure-report-assigned-practitioner': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MeasureReport/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/measure-report-evidence-text']) &gt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/measure-report-evidence-text': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/measure-report-evidence-text']) &lt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/measure-report-evidence-text': maximum cardinality of 'extension' is 1</sch:assert>
