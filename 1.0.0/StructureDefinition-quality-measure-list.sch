...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:List/f:entry">
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/measure-weight']) &gt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/measure-weight': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ibm.com/fhir/cdm/StructureDefinition/measure-weight']) &lt;= 1">extension with URL = 'http://ibm.com/fhir/cdm/StructureDefinition/measure-weight': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
